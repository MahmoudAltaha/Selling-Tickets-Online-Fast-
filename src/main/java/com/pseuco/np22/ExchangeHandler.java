...
class ExchangeHandler implements HttpHandler {
    /**
     * The request handler to hand requests over to.
     */
     ...
     * 
     * @param requestHandler The request handler to hand requests over to.
     */
    ...
    public void handle(final HttpExchange exchange) throws IOException {
        ...
        final var request = new Request(method.get(), kind.get(), exchange);
        try {
